    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="170">
        ...
        <section>
            <div class='main'>
                ...
                if (file_exists(__DIR__ . "/_views/_" . $route[0] . '/_' . $_SESSION['view'] . "_view.php")) {
                    include_once __DIR__ . "/_views/_" . $route[0] . '/_' . $_SESSION['view'] . "_view.php";
                } else {
                    if (AMBIENTE == 'DEVELOPER') {
                        echo "VIEW INEXISTENTE->/_" . $route[0] . '/_' . $_SESSION['view'] . "_view.php";
                    } else {
                        include_once __DIR__ . "/_views/_main/_index__view.php";
                    }
                }
                ?>
            </div>
