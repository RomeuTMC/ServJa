...
<div class="collapse navbar-collapse" id="main_nav">
    <ul class="navbar-nav">
        ...
        foreach ($menus as $menu) {
            if ($menu['filhos'] == 0) {
                //SE NÃO TEM FILHO
                echo "<li class='nav-item'><a class='nav-link' href='" . URL . $menu['endpoint'] . "'>"
                    . "<i class='" . $menu['icone'] . "'></i> " . $menu['menu'] . "</a></li>";
            } else {
                echo "<li class='nav-item dropdown'> <a class='nav-link dropdown-toggle' href='" . URL
                    . $menu['endpoint'] . "'data-toggle='dropdown'>" . "<i class='" . $menu['icone'] . "'></i> "
                    . $menu['menu'] . "</a>";
                submenu($menu['id']);
            }
        }
